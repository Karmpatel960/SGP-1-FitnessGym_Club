<!DOCTYPE html><html class="minimal no-js"><head>
	...
	<title>twilio-chat | twilio-chat</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-class">
			<a href="classes/ChannelDescriptor.html" class="tsd-kind-icon">Channel<wbr>Descriptor</a>
		</li>
		<li class=" tsd-kind-class">
		...
		<li class=" tsd-kind-class">
			<a href="classes/UserDescriptor.html" class="tsd-kind-icon">User<wbr>Descriptor</a>
		</li>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<a href="#twilio-chat-client-library" id="twilio-chat-client-library" style="color: inherit; text-decoration: none;">
				<h1>Twilio Chat client library</h1>
			</a>
			<p>Twilio Chat is a service for messages delivery over ip networks.
			...
			<p>To use the library you need <a href="https://www.twilio.com/docs/chat/create-tokens">to generate a token</a> and pass it to the Chat Client constructor.</p>
			<a href="#npm" id="npm" style="color: inherit; text-decoration: none;">
				<h3>NPM</h3>
			</a>
			<pre><code><span style="color: #001080">npm</span><span style="color: #000000"> </span><span style="color: #001080">install</span><span style="color: #000000"> --</span><span style="color: #001080">save</span><span style="color: #000000"> </span><span style="color: #001080">twilio</span><span style="color: #000000">-</span><span style="color: #001080">chat</span>
</code></pre>
			<p>Using this method, you can <code>require</code> <code>twilio-chat</code> and then use the client:</p>
			<pre><code><span style="color: #0000FF">const</span><span style="color: #000000"> { </span><span style="color: #0070C1">Client</span><span style="color: #000000"> } = </span><span style="color: #795E26">require</span><span style="color: #000000">(</span><span style="color: #A31515">'twilio-chat'</span><span style="color: #000000">);</span>
...
<span style="color: #000000">}</span>
			...
			<pre><code><span style="color: #AF00DB">import</span><span style="color: #000000"> { </span><span style="color: #001080">Client</span><span style="color: #000000"> } </span><span style="color: #AF00DB">from</span><span style="color: #000000"> </span><span style="color: #A31515">'twilio-chat'</span><span style="color: #000000">;</span>
<span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">client</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
<span style="color: #008000">// Before you use the client, subscribe to the `'stateChanged'` event and wait </span>
<span style="color: #008000">// for the `'initialized'` state to be reported.</span>
<span style="color: #001080">client</span><span style="color: #000000">.</span><span style="color: #795E26">on</span><span style="color: #000000">(</span><span style="color: #A31515">'stateChanged'</span><span style="color: #000000">, (</span><span style="color: #001080">state</span><span style="color: #000000">) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> {</span>
...
<span style="color: #000000">}</span>
			...
			<p>Releases of <code>twilio-chat.js</code> are hosted on a CDN, and you can include these
			directly in your web app using a <code>&lt;script&gt;</code> tag.</p>
			<pre><code class="language-html"><span style="color: #800000">&lt;script</span><span style="color: #000000FF"> </span><span style="color: #FF0000">src</span><span style="color: #000000FF">=</span><span style="color: #0000FF">"https://media.twiliocdn.com/sdk/js/chat/v6.0/twilio-chat.min.js"</span><span style="color: #800000">&gt;&lt;/script&gt;</span>
</code></pre>
			<p>Using this method, <code>twilio-chat.js</code> will set a browser global <code>Twilio.Chat</code> through which you can use the client:</p>
			<pre><code><span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">client</span><span style="color: #000000"> = </span><span style="color: #0000FF">new</span><span style="color: #000000"> </span><span style="color: #001080">Twilio</span><span style="color: #000000">.</span><span style="color: #001080">Chat</span><span style="color: #000000">.</span><span style="color: #795E26">Client</span><span style="color: #000000">(</span><span style="color: #001080">token</span><span style="color: #000000">);</span>
</code></pre>
			<a href="#changelog" id="changelog" style="color: inherit; text-decoration: none;">
				<h2>Supported Browsers</h2><table><thead><tr><th>Browser</th><th>Supported Versions</th></tr></thead><tbody><tr><td>Chrome for Android</td><td>94</td></tr><tr><td>Firefox for Android</td><td>92</td></tr><tr><td>UC Browser for Android</td><td>12.12</td></tr><tr><td>Chrome</td><td>94, 93, 92</td></tr><tr><td>Edge</td><td>94, 93, 92</td></tr><tr><td>Firefox</td><td>93, 92, 91</td></tr><tr><td>Internet Explorer</td><td>11</td></tr><tr><td>Safari for iOS</td><td>15, 14.5-14.8</td></tr><tr><td>Safari</td><td>15, 14.1, 14</td></tr><tr><td>Samsung Internet</td><td>15.0, 14.0</td></tr></tbody></table><h2>Changelog</h2>
			</a>
			<p>See this <a href="https://www.twilio.com/docs/chat/javascript/changelog#change-logs">link</a>.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class"><a href="classes/Channel.html" class="tsd-kind-icon">Channel</a></li>
							<li class="tsd-kind-class"><a href="classes/ChannelDescriptor.html" class="tsd-kind-icon">Channel<wbr>Descriptor</a></li>
							...
							<li class="tsd-kind-class"><a href="classes/Member.html" class="tsd-kind-icon">Member</a></li>
							...
							<li class="tsd-kind-class"><a href="classes/UserDescriptor.html" class="tsd-kind-icon">User<wbr>Descriptor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface"><a href="interfaces/ChannelSortingOptions.html" class="tsd-kind-icon">Channel<wbr>Sorting<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/ClientOptions.html" class="tsd-kind-icon">Client<wbr>Options</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/CreateChannelOptions.html" class="tsd-kind-icon">Create<wbr>Channel<wbr>Options</a></li>
					...
					<section class="tsd-index-section ">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelSortingCriteria" class="tsd-kind-icon">Channel<wbr>Sorting<wbr>Criteria</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelSortingOrder" class="tsd-kind-icon">Channel<wbr>Sorting<wbr>Order</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelState" class="tsd-kind-icon">Channel<wbr>State</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelStatus" class="tsd-kind-icon">Channel<wbr>Status</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelType" class="tsd-kind-icon">Channel<wbr>Type</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ChannelUpdateReason" class="tsd-kind-icon">Channel<wbr>Update<wbr>Reason</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ConnectionState" class="tsd-kind-icon">Connection<wbr>State</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#MemberType" class="tsd-kind-icon">Member<wbr>Type</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#MemberUpdateReason" class="tsd-kind-icon">Member<wbr>Update<wbr>Reason</a></li>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelSortingCriteria" class="tsd-anchor"></a>
				<h3>Channel<wbr>Sorting<wbr>Criteria</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>Sorting<wbr>Criteria<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"lastMessage"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"friendlyName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"uniqueName"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Channel sorting criteria.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelSortingOrder" class="tsd-anchor"></a>
				<h3>Channel<wbr>Sorting<wbr>Order</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>Sorting<wbr>Order<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"ascending"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"descending"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Channel sorting order.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelState" class="tsd-anchor"></a>
				<h3>Channel<wbr>State</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>State<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>current<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">"active"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"inactive"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"closed"</span><span class="tsd-signature-symbol">; </span>dateUpdated<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Date</span><span class="tsd-signature-symbol"> }</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The conversational state of the channel.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter">
							<h5>current<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">"active"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"inactive"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"closed"</span></h5>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
						...
						<li class="tsd-parameter">
							<h5>date<wbr>Updated<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Date</span></h5>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Date at which the latest channel state update happened.</p>
								</div>
							</div>
						</li>
					</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelStatus" class="tsd-anchor"></a>
				<h3>Channel<wbr>Status</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>Status<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"unknown"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"notParticipating"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"invited"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"joined"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The status of the channel, relative to the client: whether
							the channel has been <code>joined</code> or the client is
							<code>notParticipating</code> in the channel or has been <code>invited</code> to
						the channel.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelType" class="tsd-anchor"></a>
				<h3>Channel<wbr>Type</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"public"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"private"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ChannelUpdateReason" class="tsd-anchor"></a>
				<h3>Channel<wbr>Update<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">Channel<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"createdBy"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"friendlyName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastConsumedMessageIndex"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"state"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"status"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"uniqueName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastMessage"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"notificationLevel"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The reason for the <code>updated</code> event being emitted by a channel.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						...
						<ul>
							...
							<li><code>'denied'</code> - client connection is denied because of invalid JWT access token. User must
							refresh token in order to proceed</li>
						</ul>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="MemberType" class="tsd-anchor"></a>
				<h3>Member<wbr>Type</h3>
				<div class="tsd-signature tsd-kind-icon">Member<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"chat"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"sms"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"whatsapp"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Push notification type of a member.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="MemberUpdateReason" class="tsd-anchor"></a>
				<h3>Member<wbr>Update<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">Member<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"roleSid"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastConsumedMessageIndex"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastConsumptionTimestamp"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The reason for the <code>updated</code> event being emitted by a member.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Push notification type of a message.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">Message<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"body"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastUpdatedBy"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"author"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The user's notification level for the channel. Determines
							whether the currently logged-in user will receive pushes for events
							in this channel. Can be either <code>muted</code> or <code>default</code>, where
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">User<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"friendlyName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"online"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"notifiable"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
